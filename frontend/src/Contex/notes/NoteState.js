  ...
  const getNotes = async () => {
    ...
    const response = await fetch(`${host}/api/notes/fetchallnotes`, {
      ...
      headers: {
        ...
        "auth-token":"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyIjp7ImlkIjoiNjM0YTMzZmU5MGU0NWZjNzM3NWQ0NjljIn0sImlhdCI6MTY2NTgwNzM1OH0.i6jUwn1IWbEZzvCn0nxjSMN2cMGHeb3y2uLn-BHg-NI"
      }
    });
